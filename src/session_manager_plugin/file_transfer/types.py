...
class FileTransferProgress:
    ...
    @classmethod
    def create(cls, bytes_transferred: int, total_bytes: int, chunk_size: int) -> "FileTransferProgress":
...
class FileChecksum:
    ...
    @classmethod
    def compute(cls, file_path: Path, algorithm: ChecksumType = ChecksumType.MD5) -> "FileChecksum":
